#############################################################################
# Makefile for building: CO2ExchangeCoin-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: Wed 25. Feb 20:38:41 2015
# Project:  co2exchangecoin-qt.pro
# Template: app
# Command: f:\BTCDeps\Qt\4.8.5\bin\qmake.exe USE_UPNP=1 USE_QRCODE=1 -o Makefile co2exchangecoin-qt.pro
#############################################################################
...
MAKEFILE      = Makefile
QMAKE         = f:\BTCDeps\Qt\4.8.5\bin\qmake.exe
DEL_FILE      = del
...
Makefile: co2exchangecoin-qt.pro  ../Qt/4.8.5/mkspecs/default/qmake.conf ../Qt/4.8.5/mkspecs/features/device_config.prf \
		...
		f:/BTCDeps/Qt/4.8.5/lib/qtmain.prl \
		f:/BTCDeps/Qt/4.8.5/lib/QtGui.prl \
		f:/BTCDeps/Qt/4.8.5/lib/QtNetwork.prl \
		f:/BTCDeps/Qt/4.8.5/lib/QtCore.prl
	$(QMAKE) USE_UPNP=1 USE_QRCODE=1 -o Makefile co2exchangecoin-qt.pro
