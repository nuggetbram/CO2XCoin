...
public:
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAutomaticallySelected->setText(QApplication::translate("SendCoinsDialog", "Low Priority Coins Are Automatically Selected", 0, QApplication::UnicodeUTF8));
