...
public:
    ...
    QPushButton *autoSavingsPushButton;
    ...
    void setupUi(QWidget *AddressBookPage)
    {
        ...
        autoSavingsPushButton = new QPushButton(AddressBookPage);
        autoSavingsPushButton->setObjectName(QString::fromUtf8("autoSavingsPushButton"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icons/send"), QSize(), QIcon::Normal, QIcon::Off);
        autoSavingsPushButton->setIcon(icon5);

        horizontalLayout->addWidget(autoSavingsPushButton);

        deleteButton = new QPushButton(AddressBookPage);
        deleteButton->setObjectName(QString::fromUtf8("deleteButton"));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/icons/remove"), QSize(), QIcon::Normal, QIcon::Off);
